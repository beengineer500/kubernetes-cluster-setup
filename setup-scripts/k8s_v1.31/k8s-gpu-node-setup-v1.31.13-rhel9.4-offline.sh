...
echo '#===================================================#'
echo '# This is shellscript for k8s-master-node @Offline #'
echo '#===================================================#'
...
ip_tables
EOF
sudo modprobe overlay && sudo modprobe br_netfilter && sudo modprobe ip_tables
echo "===== 8) Done ====="
echo
echo
...
echo "11) Install Containerd & Docker Packages"
sudo dnf install -y /root/packages/container_packages/container-docker-package/containerd.io-1.7.28-1.el9.x86_64.rpm \
/root/packages/container-packages/container-docker-package/docker-ce-28.5.1-1.el9.x86_64.rpm \
/root/packages/container-packages/container-docker-package/docker-ce-cli-28.5.1-1.el9.x86_64.rpm \
/root/packages/container-packages/container-docker-package/docker-buildx-plugin-0.29.1-1.el9.x86_64.rpm \
/root/packages/container-packages/container-docker-package/docker-ce-rootless-extras-28.5.1-1.el9.x86_64.rpm \
/root/packages/container-packages/container-docker-package/docker-compose-plugin-2.40.3-1.el9.x86_64.rpm \
/root/packages/container-packages/container-docker-package/docker-model-plugin-0.1.44-1.el9.x86_64.rpm && sleep 1;
...
sudo dnf install -y /root/packages/container_packages/k8s-package/*.rpm && sleep 1;
echo "===== 13) Done ====="
echo
echo
